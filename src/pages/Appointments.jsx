        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-gray-100 mx-2 sm:mx-0">
            <p className="flex items-center gap-2 text-2xl font-medium text-blue-900">
              {docInfo.name} <img className="w-4" src={assets.verified_icon || "/placeholder.svg"} alt="verified" />
            </p>
            ...
            {docSlots.length &&
              docSlots.map((item, index) => (
                <div
                  ...
                  className={`text-center py-6 min-w-16 rounded-full cursor-pointer ${slotIndex === index ? "bg-orange-500 text-white" : "border border-gray-200"}`}
                  key={index}
                >
            ...
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                <p
                  ...
                  className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer ${item.time === appointmentTime ? "bg-orange-500 text-white" : "border border-gray-200"}`}
                  key={index}
                >
